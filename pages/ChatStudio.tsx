...
// Mentor phone number - update this with the actual number
const MENTOR_PHONE = '+91 7405222505'; // Change this to the mentor's actual number
...
const ChatStudio = () => {
  ...
  const handlePhoneCall = () => {
    const telNumber = `tel:${MENTOR_PHONE.replace(/\D/g, '')}`;
        ...
        <div className="glass p-6 rounded-3xl text-center">
          ...
          <div className="flex justify-center gap-2">
            <button 
              ...
              className="p-2 bg-blue-600 hover:bg-blue-700 border border-blue-500 rounded-full text-white transition-colors"
              title="Call mentor"
            >
              <Phone size={16} />
            </button>
            <button className="p-2 bg-zinc-900 border border-zinc-800 rounded-full text-zinc-400 hover:text-white transition-colors" title="Video call"><Video size={16} /></button>
            <button className="p-2 bg-zinc-900 border border-zinc-800 rounded-full text-zinc-400 hover:text-white transition-colors" title="More options"><MoreHorizontal size={16} /></button>
          </div>
        </div>
